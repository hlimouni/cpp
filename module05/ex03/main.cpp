...
{
	Intern intern;
	Form *presForm = intern.makeForm("shrubbery creation", "Target 1");
	Form *roboForm = intern.makeForm("presidential pardon", "Target 2");
	Form *shrubForm = intern.makeForm("robotomy request", "Target 3");
    try
    {
